...
![s3-console](/static/images/5-Workshop/5.3-S3-setup/s3-dashboard.png)
...
![s3-create-name-bucket](/static/images/5-Workshop/5.3-S3-setup/s3-create-name-bucket.png)
...
![input-bucket-access](/static/images/5-Workshop/5.3-S3-setup/s3-access.png)
...
![s3-kms-encryption](/static/images/5-Workshop/5.3-S3-setup/open-kms-dashboard.png)
![s3-kms-encryption](/static/images/5-Workshop/5.3-S3-setup/kms-2.png)
Nhập tên alias:
...
![s3-kms-encryption](/static/images/5-Workshop/5.3-S3-setup/kms-3.png)

Chọn IAM user quản lý hệ thống:
![s3-kms-encryption](/static/images/5-Workshop/5.3-S3-setup/kms-4.png)

Thêm IAM Role của Lambda:
![s3-kms-encryption](/static/images/5-Workshop/5.3-S3-setup/kms-5.png)
![s3-kms-encryption](/static/images/5-Workshop/5.3-S3-setup/kms-6.png)
![s3-kms-encryption](/static/images/5-Workshop/5.3-S3-setup/kms-7.png)

Chọn KMS Key vừa tạo và nhấn Create bucket:
![s3-kms-encryption](/static/images/5-Workshop/5.3-S3-setup/kms-8.png)

Vậy là ta đã có Input bucket:
![create-input-bucket](/static/images/5-Workshop/5.3-S3-setup/create-input-bucket.png)
...
![create-output-bucket](/static/images/5-Workshop/5.3-S3-setup/create-output-bucket.png)
...
![bucket-list](/static/images/5-Workshop/5.3-S3-setup/s3-dashboard.png)
