...
![upload-image](/static/images/5-Workshop/5.4-Lambda-deployment/upload-image.png)
...
![test-upload-image](/static/images/5-Workshop/5.4-Lambda-deployment/test-upload-image.png)
...
![lambda-log](/static/images/5-Workshop/5.4-Lambda-deployment/lambda-log.png)

Nếu Lambda hoạt động thành công, CloudWatch Logs sẽ hiện thị quá trình xử lý và log cuối cùng là:
![success-log](/static/images/5-Workshop/5.4-Lambda-deployment/success-log.png)
...
![output-image-1](/static/images/5-Workshop/5.4-Lambda-deployment/output-image-1.png)
![output-image-2](/static/images/5-Workshop/5.4-Lambda-deployment/output-image-2.png)
